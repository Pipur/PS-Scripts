...
function main() {
    ...
    win.pnl1a = win.add('panel', undefined, undefined, {
        borderStyle: "black"
    });
    ...
    win.pnl1a.sGrp0.p1 = win.pnl1a.sGrp0.add('panel', undefined, undefined, {
        borderStyle: "black"
    });
    ...
    try {
        ...
        win.pnl1a.sGrp1.p1 = win.pnl1a.sGrp1.add('panel', undefined, undefined, {
            borderStyle: "black"
        });
    ...
    win.pnl1a.sGrp3.p1 = win.pnl1a.sGrp3.add('panel', undefined, undefined, {
        borderStyle: "black"
    });
    ...
    win.g38.bu1.onClick = function() {
        if (win.g38.cb1.value) {
            actionArray.push([
                [win.g30.dd2.selection.text],
                [win.g30.dd1.selection.text]
            ]);
    ...
    win.p3 = win.p1.add("panel", undefined, undefined, {
        borderStyle: "etched"
    });
    ...
    pnl2 = win.add('panel', undefined, undefined, {
        borderStyle: "black"
    });
    ...
    function panelColour(HexValue, Panel) {
        ...
        switch (Panel) {
            case 1:
                C = pnl2.grp20.p1.graphics;
                var myBrush = C.newBrush(C.BrushType.SOLID_COLOR, [r, g, b, 1]);
                C.backgroundColor = myBrush;
                break;
            case 2:
                C = pnl2.grp22.p1.graphics;
                var myBrush = C.newBrush(C.BrushType.SOLID_COLOR, [r, g, b, 1]);
                C.backgroundColor = myBrush;
                break;
            default:
    ...
    pnl2.visible = false;
    pnl2.p2 = pnl2.add("panel", undefined, undefined, {
        borderStyle: "black"
    });
    ...
    function pictureProcess(PictureFiles, saveFileFolder) {
        ...
        for (var a in PictureFiles) {
            ...
            if (win.g40.cb1.value) {
                ...
                if (pnl2.grp25.cb1.value) {
                    switch (Number(pnl2.grp25.dd1.selection.index)) {
                        ...
                        case 1:
                            if (activeDocument.info.caption != '') {
                        ...
                        case 2:
                            if (activeDocument.info.headline != '') {
                        ...
                        case 3:
                            var CpyInfo = getCopyRightNotice();
                            if (CpyInfo != '') {
                                TextInfo += ' ' + CpyInfo;
                                break;
                            } else {
                ...
                switch (Position) {
                    ...
                    case 4:
                        align('AdLf');
                        align('AdCV');
                        activeDocument.activeLayer.translate(OffsetX, 0);
                        break;
                    case 5:
                        align('AdCH');
                        align('AdCV');
                        if (pnl2.grp5a.cb1.value) activeDocument.activeLayer.rotate(-45);
                        break;
                    case 6:
                        align('AdRg');
                        align('AdCV');
            ...
            switch (Number(win.g50.dd1.selection.index)) {
                case 0:
                    saveFile = saveFileFolder + Name;
                    break;
                case 1:
                    saveFile = saveFileFolder + Prefix + Name;
                    break;
                case 2:
                    saveFile = saveFileFolder + Name + Suffix;
                    break;
                case 3:
                    saveFile = saveFileFolder + Name + Seq1;
                    break;
                case 4:
                    saveFile = saveFileFolder + NewName + Seq2;
                    break;
                default:
                    break;
            }
