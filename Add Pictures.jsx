...
function main() {
    ...
    for (var f = 0; f < selectedID.length; f++) {
        if (Top > (selectedID[f][2] - plusMinus) && Top < (selectedID[f][2] + plusMinus)) {
            tmp.push([
                [Number(selectedID[f][0])],
                [Number(selectedID[f][1])]
            ]);
        } else {
    ...
    win.pnl2 = win.pnl1.add('panel', undefined, undefined, {
        borderStyle: "black"
    });
        ...
        for (var i = 0; i < sorted.length; i++) {
            ...
            switch (win.grp10.dd1.selection.index) {
                case 0:
                    break;
                case 1:
                    if (height == undefined) {} else {
                        height = (height / 100) * 101;
                    };
                    if (width == undefined) {} else {
                        width = (width / 100) * 101;
                    };
                    break;
                case 2:
