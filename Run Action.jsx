...
function main() {
    ...
    win.p1.p1 = win.p1.add("panel", undefined, undefined, {
        borderStyle: "black"
    });
    ...
    win.g5.cb1.onClick();
    win.p1.p2 = win.p1.add("panel", undefined, undefined, {
        borderStyle: "black"
    });
    ...
    win.p1.p3 = win.p1.add("panel", undefined, undefined, {
        borderStyle: "black"
    });
    ...
    win.g15.bu1.onClick = function() {
        actionArray.push([
            [win.g10.dd2.selection.text],
            [win.g10.dd1.selection.text]
        ]);
    ...
    win.g20.bu1.onClick = function() {
        if (actionArray.length == 0) actionArray.push([
            [win.g10.dd2.selection.text],
            [win.g10.dd1.selection.text]
        ]);
        win.close(1);
