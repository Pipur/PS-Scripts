...
function main() {
    ...
    win.p1 = win.all.add('panel', undefined, undefined, {
        borderStyle: 'black'
    });
    win.p1.preferredSize = [500, 425];
    win.p2 = win.all.add('panel', undefined, undefined, {
        borderStyle: 'black'
    });
    ...
    win.lb1 = win.g20.add('listbox', undefined, 'Layer List', {
        multiselect: true
    });
    ...
    win.g1080.dd1.onChange = function() {
        switch (Number(this.selection.index)) {
            ...
            case 3:
                win.g1090b.visible = false;
                win.g1090c.visible = true;
                win.g1090d.visible = false;
                break;
            case 4:
                win.g1090b.visible = true;
                win.g1090c.visible = false;
                win.g1090d.visible = false;
                break;
            case 5:
    ...
    win.g1085.p1 = win.g1085.add('panel', undefined, undefined, {
        borderStyle: 'black'
    });
    ...
    win.g1090.bu1.onClick = function() {
        ...
        for (var u = 0; u < Unticked.length; u++) {
            ...
            for (var t in Ticked) {
                selectLayerByIndex(Number(Ticked[t]), true);
            }
            dupToFile();
            ...
            switch (win.g1070.dd1.selection.index) {
                case 0:
                    saveFile = outPutFolder + "/" + LayerName;
                    break;
                case 1:
                    saveFile = outPutFolder + "/" + FileName + '-' + zeroPad((u + 1), 4);
                    break;
                case 2:
                    saveFile = outPutFolder + "/" + FileName + '-' + LayerName;
                    break;
                case 3:
                    saveFile = outPutFolder + "/" + win.g1070.et1.text + "-" + zeroPad((u + 1), 4);
                    break;
                default:
                    break;
            }
    ...
    function SaveDOC(saveFile) {
        switch (Number(win.g1080.dd1.selection.index)) {
            ...
            case 2:
                ...
                break;
            case 3:
                SaveTIFF(File(saveFile + ".tif"), Number(win.g1090c.dd1.selection.index));
                break;
            case 4:
                SaveJPG(File(saveFile + ".jpg"), Number(win.g1090b.dd1.selection.index) + 1);
                break;
            case 5:
                SaveForWeb(File(saveFile + ".jpg"), Number(win.g1090d.dd1.selection.index) + 1);
                break;
            case 6:
                savePCX(saveFile + ".pcx");
                break;
            case 7:
                saveAsPNG24SFW(File(saveFile + ".png"));
                break;
            default:
                break;
        }
