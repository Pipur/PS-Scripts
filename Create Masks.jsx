...
function main() {
    ...
    function MakeLayerMask(LayerName, Left, Top, Right, Bottom, Feather) {
        ...
        switch (Number(win.grp12.dd1.selection.index)) {
            case 0:
                ...
                break;
            case 1:
                Circle(Top, Left, Bottom, Right, Feather);
                break;
            case 2:
    ...
    function Stroke() {
        ...
        switch (Number(strokeColour)) {
            case 0:
                sColour.rgb.hexValue = '000000';
                break;
            case 1:
                sColour.rgb.hexValue = 'ffffff';
                break;
            case 2:
                sColour.rgb.hexValue = 'ff0000';
                break;
            case 3:
                sColour.rgb.hexValue = '00ff00';
                break;
            case 4:
                sColour.rgb.hexValue = '0000ff';
                break;
            default:
                sColour.rgb.hexValue = '000000';
                break;
