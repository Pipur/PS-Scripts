...
function DIYMetadata() {
    ...
    win.p1 = win.g0.add("panel", undefined, "Select Fields", {
        borderStyle: "black"
    });
    ...
    win.p2 = win.g0.add("panel", undefined, "Order Of Fields In Input File", {
        borderStyle: "black"
    });
    ...
    win.p3 = win.g0.add("panel", undefined, "Input Options", {
        borderStyle: "black"
    });
    ...
    win.p4 = win.g20.add("panel", undefined, "Select Input File", {
        borderStyle: "black"
    });
            ...
            for (var a in OrderList) {
                switch (OrderList[a].toString()) {
                    ...
                    case 'Keywords 2':
                        ...
                        break;
                    case 'Description':
                        Desc = str.shift().toString().replace(/\"/g, '');
                        doDesc = true;
                        break;
                    case 'Copyright Notice':
                        CopyInfo = str.shift().toString().replace(/\"/g, '');
                        doCopyInfo = true;
                        break;
                    case 'Headline':
                        Head = str.shift().toString().replace(/\"/g, '');
                        doHead = true;
                        break;
                    case 'Creator':
                        Creator = str.shift().toString().replace(/\"/g, '');
                        doCreator = true;
                        break;
                    case 'Title':
                        Title = str.shift().toString().replace(/\"/g, '');
                        doTitle = true;
                        break;
                    case 'Instructions':
                        Instructions = str.shift().toString().replace(/\"/g, '');
                        doInst = true;
                        break;
                    case 'Date Created':
                        scriptDate = str.shift().toString().replace(/\"/g, '');
                        d = new XMPDateTime(new Date(Date.parse(scriptDate)));
                        doDate = true;
                        break;
                    case 'Location':
                        Location = str.shift().toString().replace(/\"/g, '');
                        doLoc = true;
                        break;
                    case 'City':
                        City = str.shift().toString().replace(/\"/g, '');
                        doCity = true;
                        break;
                    case 'Country':
                        Country = str.shift().toString().replace(/\"/g, '');
                        doCountry = true;
                        break;
                    case 'Rating':
                        Rating = Number(str.shift());
                        doRating = true;
                        break;
                    case 'Label':
                        Label = str.shift().toString().replace(/\"/g, '');
                        doLabel = true;
                        break;
                    case 'Usage Terms':
                        Usage = str.shift().toString().replace(/\"/g, '');
                        doUsage = true;
                        break;
                    case 'Credit':
                        Credit = str.shift().toString().replace(/\"/g, '');
                        doCredit = true;
                        break;
                    case 'Source':
                        Source = str.shift().toString().replace(/\"/g, '');
                        doSource = true;
                        break;
                    case 'Job Identifier':
                        JobId = str.shift().toString().replace(/\"/g, '');
                        doJobId = true;
                        break;
                    default:
                        break;
                ...
                if (thumb.hasMetadata) {
                    ...
                    if (doLabel) {
                        try {
                            ...
                            sendError(errorLog, decodeURI(fileName) + " :: Unable to Copyright");
                        }
                    }
                    if (copyRight) {
                        try {
                    ...
                    if (doCreator) {
                        try {
                            ...
                            sendError(errorLog, decodeURI(fileName) + " :: Unable to add Creator");
                        }
                    }
                    if (doCopyInfo) {
                        try {
                            ...
                            sendError(errorLog, decodeURI(fileName) + " :: Bad Copyright Info : " + CopyInfo);
                        }
                    }
                    if (doRating) {
                        try {
                            ...
                            sendError(errorLog, decodeURI(fileName) + " :: Bad Rating : " + Rating);
                        }
                    }
                    ...
                    if (doInst) {
                        try {
                            ...
                            sendError(errorLog, decodeURI(fileName) + " :: Bad Instruction : " + Instructions);
                        }
                    }
                    ...
                    if (doCredit) {
                        try {
                            ...
                            sendError(errorLog, decodeURI(fileName) + " :: Bad Credit: " + Credit);
                        }
                    }
                    ...
                    if (doSource) {
                        try {
                            ...
                            sendError(errorLog, decodeURI(fileName) + " :: Bad Source: " + Source);
                        }
                    }
                    ...
                    if (doJobId) {
                        try {
                            ...
                            sendError(errorLog, decodeURI(fileName) + " :: Bad Job Id: " + JobId);
                        }
                    }
                    ...
                    if (doCountry) {
                        try {
                            ...
                            sendError(errorLog, decodeURI(fileName) + " :: Bad Country : " + Country);
                        }
                    }
                    ...
                    if (doCity) {
                        try {
                            ...
                            sendError(errorLog, decodeURI(fileName) + " :: Bad City : " + City);
                        }
                    }
                    ...
                    if (doDesc) {
                        try {
                            ...
                            sendError(errorLog, decodeURI(fileName) + " :: Bad Description : " + Desc);
                        }
                    }
                    ...
                    if (doLoc) {
                        try {
                            ...
                            sendError(errorLog, decodeURI(fileName) + " :: Bad Location : " + Location);
                        }
                    }
                    ...
                    if (Head) {
                        try {
                            ...
                            sendError(errorLog, decodeURI(fileName) + " :: Bad Headline : " + Head);
                        }
                    }
                    ...
                    if (doDate) {
                        try {
                            if (!d.toString().match(/^0000/)) {
                                ...
                                sendError(errorLog, decodeURI(fileName) + " :: Bad date : " + scriptDate);
                            }
                        } catch (e) {
                            sendError(errorLog, decodeURI(fileName) + " :: Bad date : " + scriptDate);
                        }
                    ...
                    if (doTitle) {
                        try {
                            ...
                            sendError(errorLog, decodeURI(fileName) + " :: Bad Title : " + Title);
                        }
                    }
                    ...
                    if (doUsage) {
                        try {
                            ...
                            sendError(errorLog, decodeURI(fileName) + " :: Bad Usage : " + Usage);
                        }
                    }
                    ...
                    if (doKeys) {
                        try {
                            ...
                            sendError(errorLog, decodeURI(fileName) + " :: Bad Keyword : " + Keys.toString());
                        }
                    }
