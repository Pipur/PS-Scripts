...
function main() {
    ...
    win.p2 = win.add("panel", undefined, undefined, {
        borderStyle: "black"
    });
    ...
    win.g18.dd1.onChange = function() {
        switch (Number(this.selection.index)) {
            ...
            case 3:
                win.g19b.visible = false;
                win.g19c.visible = true;
                win.g19d.visible = false;
                break;
            case 4:
                win.g19b.visible = true;
                win.g19c.visible = false;
                win.g19d.visible = false;
                break;
            case 5:
    ...
    function SaveDOC(saveFile) {
        switch (Number(win.g18.dd1.selection.index)) {
            ...
            case 2:
                ...
                break;
            case 3:
                SaveTIFF(File(saveFile + ".tif"), Number(win.g19c.dd1.selection.index));
                break;
            case 4:
                SaveJPG(File(saveFile + ".jpg"), Number(win.g19b.dd1.selection.index) + 1);
                break;
            case 5:
                SFW(saveFile);
                break;
