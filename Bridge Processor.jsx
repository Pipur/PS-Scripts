...
if (BridgeTalk.appName == "bridge") {
    ...
    function WebPictures() {
        ...
        var TemplateNames = [];
        for (var d in Templates) {
            TemplateNames.push(decodeURI(Templates[d].name.toString().replace(/\.xmp$/i, "")));
        }
        ...
        win.p2 = win.p1.add("panel", undefined, undefined, {
            borderStyle: "black"
        });
        ...
        win.p4 = win.p1.add("panel", undefined, undefined, {
            borderStyle: "black"
        });
                ...
                for (var z in sels) {
                    ...
                    switch (Number(win.g50.dd1.selection.index)) {
                        case 0:
                            ...
                            break;
                        case 1:
                            saveFile = Prefix + Name;
                            break;
                        case 2:
                            saveFile = Name + Suffix;
                            break;
                        case 3:
                            saveFile = Name + Seq1;
                            break;
                        case 4:
                            saveFile = NewName + Seq2;
                            break;
                        default:
                            break;
                    }
